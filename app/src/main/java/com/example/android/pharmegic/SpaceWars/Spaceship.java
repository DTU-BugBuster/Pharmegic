package com.example.android.pharmegic.SpaceWars;
...
public class Spaceship extends View {
    ...
    ArrayList<com.example.android.myapplication.SpaceWars.SpaceJunk> jl = new ArrayList<com.example.android.myapplication.SpaceWars.SpaceJunk>(); //Array for space junk objects
    ArrayList<com.example.android.myapplication.SpaceWars.Missile> ml = new ArrayList<com.example.android.myapplication.SpaceWars.Missile>();     //Array for missile objects
    ArrayList<com.example.android.myapplication.SpaceWars.Missile> dm = new ArrayList<com.example.android.myapplication.SpaceWars.Missile>();     //Array for missile objects to be deleted
    ...
    public void onDraw(Canvas c) {
        ...
        */
        ...
        //Space Junk Machine
        while (maxJunk !=0){
            jl.add(new com.example.android.myapplication.SpaceWars.SpaceJunk());
            maxJunk--;
        }
        ...
        if (SystemClock.uptimeMillis() - timePassed > junkDecayRate){
            ...
            com.example.android.myapplication.SpaceWars.SpaceJunk j = jl.get(junkSelector);
            jl.remove(j);            //Die
            jl.add(new com.example.android.myapplication.SpaceWars.SpaceJunk()); //Reborn!
        ...
        //Draw the space junk!
        for (com.example.android.myapplication.SpaceWars.SpaceJunk j: jl){
        ...
        //FIRE / Draw missiles!
        for (com.example.android.myapplication.SpaceWars.Missile m: ml) {
    ...
    public void fireInTheHole(){
        if (dahFlag) {
            int oldR = r;
            if (dualFire){r=0;}
            com.example.android.myapplication.SpaceWars.Missile m = new com.example.android.myapplication.SpaceWars.Missile();
            switch (dr) {
                case EAST:
                    m.my = cy;
                    m.mx = cx+r/2+13;
                    m.mr = 5;
                    m.warpDr = com.example.android.myapplication.SpaceWars.Missile.Direction.EAST;
                    dahFlag = false;
                    break;
                case WEST:
                    m.my = cy;
                    m.mx = cx-r/2-13;
                    m.mr = 5;
                    m.warpDr = com.example.android.myapplication.SpaceWars.Missile.Direction.WEST;
                    dahFlag = false;
                    break;
                case NORTH:
                    m.mx = cx;
                    m.my = cy-r/2-13;
                    m.mr = 5;
                    m.warpDr = com.example.android.myapplication.SpaceWars.Missile.Direction.NORTH;
                    dahFlag = false;
                    break;
                case SOUTH:
                    m.mx = cx;
                    m.my = cy+r/2+13;
                    m.mr = 5;
                    m.warpDr = com.example.android.myapplication.SpaceWars.Missile.Direction.SOUTH;
                    dahFlag = false;
                    break;
            }
            ml.add(m);
